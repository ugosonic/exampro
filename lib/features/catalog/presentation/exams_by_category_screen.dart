      ...
      body: NeonBackground(
        child: FutureBuilder(
          future: () async {
            ...
            // Completed exams set
            final completedRows =
                await (db.select(db.attempts)..where(
                      (a) => a.endedAt.isNotNull() & a.userEmail.equals(email),
                    ))
                    .get();
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              return Center(
                child: Text('Failed to load exams: ${snapshot.error}'),
              );
            }
            if (!snapshot.hasData) {
            ...
            final List<Map<String, dynamic>> subs = (data.subs as List)
            ...
            String labelFor(int? sid) {
              ...
              return sanitizeDisplayText((m['name'] as String?) ?? 'General');
            }
            ...
            final children = <Widget>[
              Card(
                child: ListTile(
                  ...
                  title: const Text(
                    'Practice all questions in this category (untimed)',
                  ),
                ...
                final locked =
                    ...
                    (catLocked ||
                        (e.subcategoryId != null &&
                            (subLocked[e.subcategoryId] == true)));
                  ...
                  Container(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        ...
                        child: Icon(_iconForExam(e.id), color: Colors.white),
                      ),
                      title: Text(
                        sanitizeDisplayText(e.title),
