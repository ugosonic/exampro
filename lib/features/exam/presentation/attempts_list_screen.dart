...
class _AttemptsListScreenState extends ConsumerState<AttemptsListScreen> {
  ...
  Future<void> _loadMore() async {
    ...
    final more = await (db.select(db.attempts)
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, i) {
          ...
          return Card(
            child: ListTile(
              leading: Icon(a.endedAt == null ? Icons.play_arrow : Icons.check, color: a.endedAt == null ? Colors.orange : Colors.green),
              title: Text('Exam #${a.examId} • ${a.endedAt == null ? 'In progress' : 'Score ${a.scorePercent}%'}'),
